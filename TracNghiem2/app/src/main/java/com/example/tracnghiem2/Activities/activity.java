...
public class activity extends AppCompatActivity {
 ...
 public static  int kq = 0; //lưu số câu trả lời đúng
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadHighScore();
        SoundBackground = MediaPlayer.create(activity.this, R.raw.purple1);
        ...
        totalTimer = 10;
        timer = new activity.CounterClass(totalTimer * 60 * 1000, 1000);
...
//Lấy giá trị (ví trí) radiogroup chuyển thành đáp an A/B/C/D
