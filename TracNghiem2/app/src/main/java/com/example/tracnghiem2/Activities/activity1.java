...
import com.example.tracnghiem2.Result.activity_result1;
...
import DBHELPER.DatabaseHelper1;
...
public class activity1 extends AppCompatActivity {
   ...
   public static int kq = 0; //lưu số câu trả lời đúng
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadHighScore();
        SoundBackground = MediaPlayer.create(activity1.this, R.raw.purple1);
        ...
        totalTimer = 10;
        timer = new activity1.CounterClass(totalTimer * 60 * 1000, 1000);
        ...
        BT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position >= Questions.size()) {
                    Intent intent = new Intent(activity1.this, activity_result1.class);
