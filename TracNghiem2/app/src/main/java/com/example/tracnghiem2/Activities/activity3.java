...
import com.example.tracnghiem2.Result.activity_result3;
...
import DBHELPER.DatabaseHelper3;
...
public class activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadHighScore();
        SoundBackground = MediaPlayer.create(activity3.this, R.raw.purple1);
        ...
        totalTimer = 10;
        timer = new activity3.CounterClass(totalTimer * 60 * 1000, 1000);
        ...
        BT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position >= Questions.size()) {
                    Intent intent = new Intent(activity3.this, activity_result3.class);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            Intent intent = new Intent(activity3.this, activity_result.class);
            Bundle bundle = new Bundle();
            bundle.putInt("KQ", kq);
    ...
    public void ReadDataFromSQL() {
        DatabaseHelper3 databaseHelper = new DatabaseHelper3(this);
