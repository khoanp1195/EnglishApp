...
import com.example.tracnghiem2.Result.activity_result4;
...
import DBHELPER.DatabaseHelper4;
...
public class activity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadHighScore();
        SoundBackground = MediaPlayer.create(activity4.this, R.raw.purple1);
        ...
        totalTimer = 10;
        timer = new activity4.CounterClass(totalTimer * 60 * 1000, 1000);
        ...
        BT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position >= Questions.size()) {
                    Intent intent = new Intent(activity4.this, activity_result4.class);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            Intent intent = new Intent(activity4.this, activity_result.class);
            Bundle bundle = new Bundle();
            bundle.putInt("KQ", kq);
    ...
    public void ReadDataFromSQL() {
        DatabaseHelper4 databaseHelper = new DatabaseHelper4(this);
