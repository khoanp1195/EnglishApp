...
import com.example.tracnghiem2.Result.activity_result5;
...
import DBHELPER.DatabaseHelper5;
...
public class activity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadHighScore();
        SoundBackground = MediaPlayer.create(activity5.this, R.raw.purple1);
        ...
        totalTimer = 10;
        timer = new activity5.CounterClass(totalTimer * 60 * 1000, 1000);
        ...
        BT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position >= Questions.size()) {
                    Intent intent = new Intent(activity5.this, activity_result5.class);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            Intent intent = new Intent(activity5.this, activity_result.class);
            Bundle bundle = new Bundle();
            bundle.putInt("KQ", kq);
