...
public class activity_cat2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        De.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity_cat2.this, com.example.tracnghiem2.Start2.EasyStart.class);
        ...
        Kho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_cat2.this, com.example.tracnghiem2.Start2.HardStart.class);
                startActivity(intent);
                overridePendingTransition(R.anim.anim_enter, R.anim.anim_exit);
        ...
        ratkho.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(activity_cat2.this, com.example.tracnghiem2.Start2.VeryHardStart.class);
                startActivity(intent);
                overridePendingTransition(R.anim.anim_enter, R.anim.anim_exit);
