...
public class activity_cat3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        De.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity_cat3.this, com.example.tracnghiem2.Start3.EasyStart.class);
        ...
        Kho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_cat3.this, com.example.tracnghiem2.Start3.HardStart.class);
                startActivity(intent);
                overridePendingTransition(R.anim.anim_enter, R.anim.anim_exit);
        ...
        ratkho.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(activity_cat3.this, com.example.tracnghiem2.Start3.VeryHardStart.class);
                startActivity(intent);
                overridePendingTransition(R.anim.anim_enter, R.anim.anim_exit);
