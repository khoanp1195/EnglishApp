...
public class activity_cat5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        De.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity_cat5.this, com.example.tracnghiem2.Start5.EasyStart.class);
        ...
        Kho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_cat5.this, com.example.tracnghiem2.Start5.HardStart.class);
                startActivity(intent);
                overridePendingTransition(R.anim.anim_enter, R.anim.anim_exit);
        ...
        ratkho.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(activity_cat5.this, com.example.tracnghiem2.Start5.VeryHardStart.class);
                startActivity(intent);
                overridePendingTransition(R.anim.anim_enter, R.anim.anim_exit);
