...
import static com.example.tracnghiem2.Activities.activity.kq;
...
public class activity_result extends Activity {
   ...
   public int soo = cauhoi - kq;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SoundBackground = MediaPlayer.create(activity_result.this, R.raw.preview);
        ...
        btnSaveSv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity_result.this, com.example.tracnghiem2.quanlysinhvien.MainActivity.class);
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        kq= 0 ;
                        finish();
                        Intent intent = new Intent(activity_result.this, TracNghiem.class);

                        intent.putExtra("arr_Ques",Questions);
                        startActivity(intent);
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String room = edtMSSV.getText().toString();
