...
import com.example.tracnghiem2.Activities.activity2;
...
import static com.example.tracnghiem2.Activities.activity3.kq;
...
public class activity_result3 extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        scoreController = new ScoreController(activity_result3.this);
        SoundBackground = MediaPlayer.create(activity_result3.this, R.raw.preview);
        ...
        btnSaveSv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity_result3.this, com.example.tracnghiem2.quanlysinhvien.MainActivity.class);
        ...
        btnagain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(activity_result3.this);
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(activity_result3.this, TracNghiem.class);
                        kq= 0 ;
                        startActivity(intent);
        ...
        MainActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(activity_result3.this);
                LayoutInflater inflater = activity_result3.this.getLayoutInflater();
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(activity_result3.this, "Lưu điểm thành công!", Toast.LENGTH_LONG).show();
                        finish();
                        dialog.dismiss();
                    }
                });
