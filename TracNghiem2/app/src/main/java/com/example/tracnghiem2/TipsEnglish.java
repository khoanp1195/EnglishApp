...
public class TipsEnglish extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photoView.setImageResource(R.drawable.tip1);
        photoView.setImageResource(R.drawable.tip2);
        photoView.setImageResource(R.drawable.tip3);
        photoView.setImageResource(R.drawable.tip4);
        photoView.setImageResource(R.drawable.tip5);
        photoView.setImageResource(R.drawable.tip6);
...
//                displayToast(countryCodes[position]);
                ...
                imageView1.setImageResource(getResources().getIdentifier(countryCodes[position], "drawable", "com.example.tracnghiem2"));
            }
        });
    }
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (lastSelectedCountryCode != null) {
            final ImageView imageView1 = findViewById(R.id.imageView1);
            imageView1.setImageResource(getResources().getIdentifier(lastSelectedCountryCode, "drawable", "com.example.tracnghiem2"));
        }
    }
    ...
    private void goToMainActivity() {
        Intent intentMainActivity = new Intent(getApplicationContext(), TracNghiem.class);
