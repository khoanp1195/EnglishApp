...
import com.example.tracnghiem2.quanlysinhvien.SuaSinhVienActivity;
import com.example.tracnghiem2.quanlysinhvien.ThemSvActivity;
...
public class SinhVienAdapter extends ArrayAdapter<SinhVien> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
       ...
       // TextView txtEmail = view.findViewById(R.id.txtDiem);
        //TextView txtroom = view.findViewById(R.id.txtroom);
        TextView txtScore = view.findViewById(R.id.txtDiem);
        ...
        txtScore.setText(sinhVien.getMssv());

        txtId.setText(sinhVien.getEmail());




        ImageView btnMenu = view.findViewById(R.id.Menu);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        if(menuItem.getItemId() == R.id.item_them_sv){
                            ...
                            Intent intent = new Intent(activity, SuaSinhVienActivity.class);
